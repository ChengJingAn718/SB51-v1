...
let titleAudio = new loadSound('ep_51_audio_01');

let bodyAudio = new loadSound('ep_51_audio_01');
let subBodyAudio = new loadSound('ep_51_audio_01');

let wordAudio1 = new loadSound('ep_51_audio_01');
let wordAudio2 = new loadSound('ep_51_audio_01');
let wordAudio3 = new loadSound('ep_51_audio_01');
let wordAudio4 = new loadSound('ep_51_audio_01');
...
let bubbleAudio = new loadSound('soap_effect', true)

clickAudio.volume = 0.0;
buzzAudio.volume = 0.4;
backAudio.volume = 0.1;
bubbleAudio.volume = 0.07;
yeahAudio.volume = 0.7;
wooAudio.volume = 0.7;

let audioListForMute = [
    titleAudio, bodyAudio, subBodyAudio, wordAudio1, wordAudio2,
    wordAudio3, wordAudio4, clickAudio, clapAudio, backAudio, buzzAudio, yeahAudio,
    tingAudio, wooAudio, bubbleAudio
]
var isOff = false;


let audioList = {
    titleAudio, bodyAudio, wordAudio1, wordAudio2, wordAudio3, wordAudio4,
    clickAudio, clapAudio, backAudio, buzzAudio, yeahAudio, tingAudio, wooAudio, subBodyAudio, bubbleAudio
}
...
export default function BaseShot() {
    ...
    function setBackground(imgUrl, optionNum = -1, backState = 1) {
        if (imgUrl != oldBackgroundImage) {
            ...
            myImage1.current.src = prePathUrl() + "images/sb_51_bg/" + oldBackgroundImage + ".svg";
            setSuitableBackground(backState);

            setTimeout(() => {
                myImage.current.src = prePathUrl() + "images/sb_51_bg/" + oldBackgroundImage + ".svg";
        ...
        >
            <div
                ...
                <img draggable={false}
                    height={"100%"}
                    ref={myImage}
                    src={prePathUrl() + "images/sb_51_bg/sb_51_intro_bg_01.svg"}
                />
            </div>
            <div
                ref={imageBack1}
